...
export function buildCourseLevels() {
    ...
    return [
        mk('kt-s-ngang-hep', 'S ngang · hẹp', 'Cua S ngang — bán kính nhỏ', sCurveHorizontalPoints(cx, cy, 420, 70), { cpR: 26 }),
        mk('kt-s-ngang-rong', 'S ngang · rộng', 'Cua S ngang — bán kính lớn', sCurveHorizontalPoints(cx, cy, 480, 110), { cpR: 32 }),
        mk('kt-s-doc-hep', 'S dọc · hẹp', 'Cua S dọc — hành lang hẹp', sCurveVerticalPoints(cx, cy, 70, 400), { cpR: 26 }),
        mk('kt-s-doc-rong', 'S dọc · rộng', 'Cua S dọc — hành lang rộng', sCurveVerticalPoints(cx, cy, 110, 460), { cpR: 32 }),
        mk('kt-tam-giac', 'Tuyến tam giác', 'Bay vòng tam giác đều', polygonPoints(cx, cy, 180, 3)),
        mk('kt-vuong-tuyen', 'Tuyến vuông', 'Bay vòng vuông trên sân', polygonPoints(cx, cy, 170, 4, -Math.PI / 4)),
        mk('kt-ngu-giac', 'Tuyến ngũ giác', 'Bay vòng ngũ giác', polygonPoints(cx, cy, 165, 5)),
        mk('kt-bay-vuong', 'Bay vuông', 'Vuông lớn · 4 góc', polygonPoints(cx, cy, 200, 4, -Math.PI / 4), { cpR: 34 }),
        mk('kt-so-8', 'Số 8', 'Figure-eight · chuyển hướng liên tục', figureEightPoints(cx, cy, 150)),
        {
            id: 'kt-khan-cap',
            branch: 'khoa-tuyen',
            name: 'Bay khẩn cấp',
            desc: 'Leo nhanh · thoát · hạ gấp',
        ...
        },
        {
            ...
            branch: 'khoa-tuyen',
            name: 'Xoay tại chỗ',
            desc: 'Pirouette · giữ vị trí · xoay 360°',
        ...
        },
        {
            ...
            branch: 'khoa-tuyen',
            name: 'Điểm xuất phát',
            desc: 'Sân tự do · luyện ga và xoay',
